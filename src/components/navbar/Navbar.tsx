    ...
    return (
        <div className="main-nav">
            <div className="nav-left">
                ...
                <div className="nav-menu">
                    <ul className='nav-list'>
                        ...
                        <li className='nav-items'>Refinance</li>
                        <li className='nav-items'>HELOC</li>
                        <li className='nav-items'>Rates</li>
                        <li className='nav-items'>Better+</li>
                    </ul>
                </div>
            </div>
            <div className="nav-right">
                ...
                <a className='nav-button' href="#">Sign in</a>
            </div>
        </div>
    );
}
